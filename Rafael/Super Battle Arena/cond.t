...
procedure p1cond
    ...
    if p1fc = 1 and p1ac = 2 and p1bc <= bstmax then
	p1s (3) := p1s (3) + 15
    ...
    if p1fc = 2 and p1ac = 2 and p1bc <= bstmax then
	p1s (4) := p1s (4) + 25
    ...
    if p1fc = 3 and p1ac = 2 and p1bc <= bstmax then
	p1s (2) := p1s (2) + 25
...
procedure p2cond
    % Swordman Conditionals
    % Conditional for Sky Uppercut
    if p2fc = 1 and p2ac = 2 and p2bc <= bstmax then
	p2s (3) := p2s (3) + 15
    ...
    % Punchman Conditionals
    % Conditional for Helichopter
    if p2fc = 2 and p2ac = 2 and p2bc <= bstmax then
	p2s (4) := p2s (4) + 25
    ...
    % Magedude Conditionals
    % Conditional for Energy Blast
    if p2fc = 3 and p2ac = 2 and p2bc <= bstmax then
	p2s (2) := p2s (2) + 25
